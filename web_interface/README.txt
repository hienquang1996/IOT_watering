itDEPLOY FRONT-END FOR TESTING
...
-Get all data of mcu that it send to server: https://iot-assignment.herokuapp.com/getall?mcu=123 (it will limit at most 10 records)
